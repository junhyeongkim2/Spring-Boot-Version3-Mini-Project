...
import miniproject.blog.config.jwt.JwtFactory;
import miniproject.blog.config.jwt.JwtProperties;
import miniproject.blog.domain.RefreshToken;
import miniproject.blog.domain.User;
import miniproject.blog.dto.CreateAccessTokenRequest;
...
public class TokenApiControllerTest {
    ...
    public void createNewAccessToken() throws Exception {
        ...
        final String requestBody = obejcetMapper.writeValueAsString(request);
